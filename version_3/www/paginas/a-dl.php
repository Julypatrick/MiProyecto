...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr style="background-image:url(../img/fondo_8.gif)">
    <td width="698" height="317"><p>&nbsp;</p><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
	  <h3 align="center">Devolucion Libros</h3>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" required	>Prestamo:</td>
          <td required><select name="Prestamo">
            <?php 
do {  
?>
...
?>
        ...
        <tr valign="baseline">
          ...
          <td required><select name="Bibliotecologo">
            <?php 
do {  
?>
...
?>
        ...
        <tr valign="baseline">
          ...
          <td required><select name="Sancion">
            <?php 
do {  
?>
