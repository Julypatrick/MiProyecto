...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO sanciones (Codigo, usuario, Valor_Sancion) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['Codigo'], "int"),
                       GetSQLValueString($_POST['usuario'], "double"),
                       GetSQLValueString($_POST['Valor_Sancion'], "text"));
...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr style="background-image:url(fondo_8.gif)">
    <td width="698" height="236" background="../img/fondo_8.gif"><p>&nbsp;</p><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
  <h3 align="center">Sanciones<h3>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Valor Sancion:</td>
      <td><input type="text" name="Valor_Sancion" value="" size="32" required/></td>
    </tr>
    <tr valign="baseline">
...
<td width="103"   bgcolor="#FFFFFF"><p align="center"><font face="Comic Sans MS, cursive" color="" ><a href="a-s.php">Sanciones</a></font></td>
