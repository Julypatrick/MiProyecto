...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr>
    ...
    <td width="81"  bgcolor="#FFFFFF"><p align="center"><font face="Comic Sans MS, cursive" color="" ><a href="a-ru.php">Registro Usuario</a></font></td>
...
<table width="708" border="1" bordercolor="#000000" align="center">
  ...
  <td width="698" height="491"><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
	<h3 align="center">Registro Usuarios
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Codigo:</td>
        <td><input type="text" name="Codigo" value="" size="25" required/></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left" required>Tipo Documento:</td>
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="Direccion" value="" size="25" /></td>
      </tr>
      <tr valign="baseline">
