...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO editorial (Nombre) VALUES (%s)",
...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr style="background-image:url(girl.gif)">
    <td width="698" height="106" background="../img/fondo_8.gif">&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
		<h3 align="center">Registro Editorial<h3>
          <tr valign="baseline">
...
<td width="103"   bgcolor="#FFFFFF"><p align="center"><font face="Comic Sans MS, cursive" color="" ><a href="a-re.php">Registro Editorial</a></font></td>
