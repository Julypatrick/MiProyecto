...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO autores (Nombres, Ciudad_Origen) VALUES (%s, %s)",
...
<table align="center">
  <tr>
    ...
    <td width="494" ><p align="center"><img src="../imag/bienvenido.png" width="448" height="78" /></td> 
  </tr>
</table>
...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr>
    ...
    <td width="81"><p align="center"><font face="Comic Sans MS, cursive" color="" ><a href="a-rl.php">Registro Libros</a></font></td>
      <td width="81"  bgcolor="#FFFFFF"><p align="center"><font face="Comic Sans MS, cursive" color="" ><a href="a-rau.php">Registro Autor</a></font></td>
...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr style="background-image:url(../img/fondo_8.gif)">
    <td width="698" height="236"><p>&nbsp;</p><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
	<h3 align="center">Registro Autor</h3>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Nombres:</td>
            <td><input type="text" name="Nombres" value="" size="32" required /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Pais:</td>
            <td><input type="text" name="Ciudad_Origen" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
