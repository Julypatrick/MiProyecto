...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO prestamos (Libro, Usuario, Bibliotecologo, Dia, Mes, Ano, Dia_Dev., Mes_Dev, Ano_Dev.) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_proyecto, $proyecto);
$query_bibliotecologo = "SELECT Codigo, Nombres FROM administradores";
...
<table align="center">
  <tr>
    <td width="160"><img src="../img/rl.png"/></td>
    <td width="494" ><p align="center"><img src="../img/bienvenidos.png" width="448" height="78" /></td> 
  </tr>
</table>
...
<table width="708" border="1" bordercolor="#000000" align="center">
  <tr style="background-image:url(fondo_8.gif)">
    <td width="698" height="383" background="../img/fondo_8.gif">
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Ano_Dev" value="" size="10" /></td>
        </tr>
        <tr valign="baseline">
...
<td width="103" ><p align="center"><font face="Comic Sans MS, cursive" color="" ><a href="a-rb.php">Sanciones</a></font></td></tr>
</table>
</body>
</html>
<?php
